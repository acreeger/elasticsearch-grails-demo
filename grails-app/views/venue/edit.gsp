...
<%@ page import="org.cafeCentro.Venue" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="coords"><g:message code="venue.coords.label" default="Coords" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: venueInstance, field: 'coords', 'errors')}">
                                    <g:textField name="coords" value="${venueInstance?.coords}" />
                                </td>
                            </tr>
